...
def parse_argv():
    ...
    parser.add_argument('--search', required = False, default = 'anthrax', help = 'search for disease')
    parser.add_argument('--date-start', required = False, default = '', help = 'start of search range (format YYYY-MM-DD)')
